...
config :youtube_tracker, YoutubeTrackerWeb.GuardianSerializer,
  issuer: "youtube_tracker",
  ttl: {30, :days},
  verify_issuer: true,
  serializer: YoutubeTrackerWeb.GuardianSerializer,
  secret_key: "d5unctzZU90a+VtyLOHIlJI+uKddLMVccekDiPQJAxcNQzKYjSlHgTMxERHHoPbS"
